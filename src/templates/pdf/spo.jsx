              ...
              <View style={styles.tableRow}>
                ...
                >
                  <View style={styles.tableCell}>
                    ...
                    <Text>
                      {new Date(detail.tgl_terbit).toLocaleDateString('id-ID', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                      })}
          ...
          <View style={styles.tableRow}>
            ...
            >
              <View style={{ padding: 10 }}>
                ...
                >
                  {decodeHtml(detail.detail ? detail.detail.tujuan : '')}
                </Html>
              </View>
            </View>
          </View>
          ...
          <View style={styles.tableRow}>
            ...
            >
              <View style={{ padding: 0 }}>
                ...
                >
                  {decodeHtml(detail.detail ? detail.detail.kebijakan : '')}
                </Html>
              </View>
            </View>
          </View>
          ...
          <View style={styles.tableRow}>
            ...
            >
              <View style={{ padding: 0 }}>
                ...
                >
                  {decodeHtml(detail.detail ? detail.detail.prosedur : '')}
                </Html>
              </View>
            </View>
          </View>
