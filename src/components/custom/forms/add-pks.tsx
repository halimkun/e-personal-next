...
const FormAddPks = ({
  ...
  const [selectedType, setSelectedType] = useState<'internal' | 'eksternal'>(
    typeSelected ?? 'internal'
  );
  const [tglTerbit, setTglTerbit] = useState<string>(
    ...
    <form method='post' encType='multipart/form-data' onSubmit={onSubmit}>
      ...
      <div className='mb-4 space-y-1'>
        ...
        <Input
          ...
          className='border border-warning/80'
          value={tglTerbit}
