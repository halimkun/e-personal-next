...
export default function FormAddSuratInternal(penanggungJawab: any) {
  ...
  const onFormAddSuratInternalSubmit = async (event: React.SyntheticEvent) => {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/surat/internal/create`,
      {
        method: 'POST',
        headers: {
  ...
  return (
    <form
      action='#!'
      method='post'
      onSubmit={onFormAddSuratInternalSubmit}
      className='w-full'
    >
      <div className='flex w-full flex-col items-start justify-start gap-3 lg:flex-row'>
        <Card className='w-full lg:sticky lg:top-[68px] lg:w-[75%]'>
          ...
          <CardContent className='p-3'>
                  ...
                  <div className='flex items-center justify-between pr-1'>
                    ...
                    <Popover>
                      ...
                      <PopoverContent className='text-sm'>
                        ...
                        digunakan untuk kegiatan yang akan dilaksanakan, tanggal
                        ini tidak akah berpengaruh pada penomoran surat.
                      </PopoverContent>
                    </Popover>
                  </div>
                  <Input
            ...
            <div className='mt-4 flex justify-between'>
              <Button
                type='button'
                variant={withKaryawan ? 'default' : 'outline'}
                onClick={() => {
        ...
        <div className='flex w-full flex-col gap-3'>
          ...
          <Card className='w-full'>
            <CardHeader>
              ...
              <CardDescription>
                Jika karyawan dipilih surat yang dibuat akan dianggap sebagai
                undangan
              </CardDescription>
            </CardHeader>
            <CardContent>
