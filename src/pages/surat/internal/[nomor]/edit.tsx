...
const SelectPenanggungJawab = dynamic(
  () => import('@/components/custom/inputs/penanggung-jawab-select'),
  { ssr: false }
);
...
const EditSuratInternal: NextPageWithLayout = ({ nomor }: any) => {
  ...
  const onSubmit = async (e: any) => {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/surat/internal/update`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
    ...
    if (response.success) {
      ...
      route.push(
        `/surat/internal/${noSurat?.toString().replace(/\//g, '_')}/detail`
      );
    } else {
      setOnUpdate(false);
  ...
  return (
    <div className=''>
      <div className='mb-5'>
        <div className='flex items-center gap-4'>
          ...
          <div className='flex flex-col gap-0.5'>
            ...
            <CardDescription>
              Edit detail Surat Internal dengan nomor{' '}
      ...
      >
        <Card className='sticky top-16 w-full'>
          <CardHeader>
          ...
          <CardContent>
            ...
            <div className='mb-3 w-full space-y-1'>
              <div className='flex items-center justify-between pr-1'>
                ...
                <Popover>
                  <PopoverTrigger>
                    <IconInfoCircle
                      className='animate-pulse cursor-pointer stroke-danger'
                      size={18}
                      strokeWidth={2}
                    />
                  </PopoverTrigger>
                  <PopoverContent className='text-sm'>
                    <strong>Tanggal Terbit : </strong> adalah tanggal yang
                    digunakan untuk keperluan penomoran surat.
                  </PopoverContent>
                </Popover>
              </div>
              <Input
            ...
            <div className='mb-3 space-y-1'>
              <div className='flex items-center justify-between pr-1'>
                ...
                <Popover>
                  ...
                  <PopoverContent className='text-sm'>
                    <strong>Tanggal Kegiatan : </strong> adalah tanggal yang
                    digunakan untuk kegiatan yang akan dilaksanakan, tanggal ini
                    tidak akah berpengaruh pada penomoran surat. <br />
                    <br />
                    tanggal pada nomor surat akan diambil dari tanggal surat
                    dibuat.
                  </PopoverContent>
                </Popover>
              </div>
              <Input
                ...
                placeholder='tanggal'
                id='tanggal'
                defaultValue={data?.data?.tanggal}
              />
            </div>
            <div className='mb-3 w-full space-y-1'>
            ...
            <div className='mb-3 w-full space-y-1'>
              <Label className='text-primary' htmlFor='tempat'>
                Tempat
              </Label>
              <Input
                type='text'
            ...
            <div className='mt-4 flex justify-end'>
              <Button type='submit'>
                <div className='justify flex items-center gap-3'>
                  {onUpdate ? (
                    <IconLoader
        ...
        <div className='flex w-full flex-col gap-3'>
          <Card className='w-full'>
            <CardHeader>
              ...
              <CardDescription>
                Catatan Tambahan untuk surat internal ini
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-1'>
                ...
                <Textarea
                  name='catatan'
                  id='catatan'
                  placeholder='catatan untuk surat ini'
                  defaultValue={data?.data?.catatan ?? ''}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className='w-full'>
            <CardHeader>
              ...
              <CardDescription>
                Pilih karyawan sebagai undangan untuk surat ini.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <LaravelPagination
