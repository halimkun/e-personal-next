...
const PPIPage: NextPageWithLayout = () => {
  ...
  const { data, error, mutate, isLoading, isValidating } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/berkas/ppi`, fetcher, {
  ...
  return (
    <div>
      <div className="w-full flex items-center justify-between">
        ...
        <Link href="/berkas/ppi/new" className={buttonVariants({
          variant: 'default',
          size: 'sm',
