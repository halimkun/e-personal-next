...
const PPIPage: NextPageWithLayout = () => {
  ...
  const { data, error, mutate, isLoading, isValidating } = useSWR(
    `${process.env.NEXT_PUBLIC_API_URL}/berkas/ppi`,
    fetcher,
    {
    ...
    <div>
      <div className='flex w-full items-center justify-between'>
        <div className='border-l-4 border-primary bg-gray-100 px-2 dark:bg-gray-900'>
          <h4 className='text-xl font-semibold text-primary'>Berkas PPI</h4>
        </div>
        <Link
          href='/berkas/ppi/new'
...
PPIPage.getLayout = function getLayout(page: ReactElement) {
