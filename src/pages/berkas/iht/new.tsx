  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start gap-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-primary">Form berkas / dokument <span className="font-bold">in house training</span> (IHT)</CardTitle>
          <CardDescription>Form untuk menambahkan data berkas berkas / dokument <span className="font-bold">in house training</span> (IHT)</CardDescription>
        </CardHeader>
        <CardContent>
          <FormAddPPI
      ...
      <Card className="w-[50%]">
        <CardHeader>
          ...
          <CardDescription>Informasi tambahan untuk menambahkan data berkas berkas / dokument <span className="font-bold">in house training</span> (IHT)</CardDescription>
        </CardHeader>
        <CardContent>
        </CardContent>
      </Card>
