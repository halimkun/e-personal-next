...
const EditNotulenPage = (props: any) => {
  ...
  const [notulenData, setNotulenData] = useState(notulen.success ? notulen.data : null);
        ...
        <CardHeader className="p-3">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <CardDescription>Edit notulen kegiatan | <strong>RSIA Aisyiyah Pekajangan</strong></CardDescription>
            </div>
          </div>
        </CardHeader>
      </Card>
...
export async function getServerSideProps(context: any) {
  ...
  const resNotulen = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/berkas/notulen/${nomor}/show`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${session?.rsiap?.access_token}`,
