...
const CreateKomiteKeperawatanBerkasPage: NextPageWithLayout = () => {
  ...
  const onSubmit = async (e: any) => {
    ...
    toast.promise(
      fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/berkas/komite/keperawatan/store`,
        {
          method: 'POST',
          headers: {
    ...
    <div className='flex flex-col-reverse items-start gap-6 lg:flex-row'>
      <Card className='w-full'>
        <CardHeader>
          <CardTitle className='text-primary'>
            Form Komite Keperawatan
          </CardTitle>
          <CardDescription>
            Form untuk menambahkan data berkas Komite Keperawatan
          </CardDescription>
        </CardHeader>
        <CardContent>
          <FormAddPPI
      ...
      <Card className='w-[50%]'>
        <CardHeader>
          ...
          <CardDescription>
            Informasi tambahan untuk menambahkan data berkas Komite Keperawatan
          </CardDescription>
        </CardHeader>
