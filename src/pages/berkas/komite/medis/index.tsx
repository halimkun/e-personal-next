...
const KomiteMedisPage: NextPageWithLayout = () => {
  ...
  const { data, error, mutate, isLoading, isValidating } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/berkas/komite/medis`, fetcher, {
  ...
  return (
    <div>
      <div className="w-full flex items-center justify-between">
        ...
        <Link href="/berkas/komite/medis/new" className={buttonVariants({
          variant: 'default',
          size: 'sm',
