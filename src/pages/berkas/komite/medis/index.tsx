...
const KomiteMedisPage: NextPageWithLayout = () => {
  ...
  const { data, error, mutate, isLoading, isValidating } = useSWR(
    `${process.env.NEXT_PUBLIC_API_URL}/berkas/komite/medis`,
    fetcher,
    {
  ...
  const onDelete = async (e: any) => {
    ...
    toast.promise(
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/berkas/komite/medis/delete`, {
        method: 'POST',
        headers: {
...
KomiteMedisPage.getLayout = function getLayout(page: ReactElement) {
  return <AppLayout>{page}</AppLayout>;
};

export default KomiteMedisPage;
