    ...
    <div className="flex flex-col-reverse lg:flex-row items-start gap-6">
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>Form untuk menambahkan data berkas Komite Medis</CardDescription>
        </CardHeader>
        <CardContent>
          <FormAddPPI
      ...
      <Card className="w-[50%]">
        <CardHeader>
          ...
          <CardDescription>Informasi tambahan untuk menambahkan data berkas Komite Medis</CardDescription>
        </CardHeader>
        <CardContent>
        </CardContent>
      </Card>
