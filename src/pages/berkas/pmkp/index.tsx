...
const PMKPPage: NextPageWithLayout = () => {
  ...
  const { data, error, mutate, isLoading, isValidating } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/berkas/pmkp`, fetcher, {
  ...
  return (
    <div>
      <div className="w-full flex items-center justify-between">
        ...
        <Link href="/berkas/pmkp/new" className={buttonVariants({
          variant: 'default',
          size: 'sm',
