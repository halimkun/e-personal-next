...
const CreateBerkasRadiologiPage: NextPageWithLayout = () => {
  ...
  const onSubmit = async (e: any) => {
    ...
    // post to /berkas/radiologi/store
    toast.promise(
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/berkas/radiologi/store`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start gap-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-primary">Form berkas / dokument radiologi</CardTitle>
          <CardDescription>Form untuk menambahkan data berkas berkas / dokument radiologi</CardDescription>
        </CardHeader>
        <CardContent>
          <FormAddPPI
      ...
      <Card className="w-[50%]">
        <CardHeader>
          ...
          <CardDescription>Informasi tambahan untuk menambahkan data berkas berkas / dokument radiologi</CardDescription>
        </CardHeader>
        <CardContent>
        </CardContent>
      </Card>
